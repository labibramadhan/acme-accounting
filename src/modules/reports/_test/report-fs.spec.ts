...
describe('Report - Type: Financial Statement', () => {
  ...
  it(
    'should generate a financial statement report in the background',
    async () => {
      ...
      const spyReportGeneratorFSGenerate = jest.spyOn(
        ReportFSUsecase.prototype,
        'generate',
      );
      ...
      const resultDTO = await controller.generateFS();
      ...
      const generateResultDTO =
        await spyReportGeneratorFSGenerate.mock.results[0].value;
