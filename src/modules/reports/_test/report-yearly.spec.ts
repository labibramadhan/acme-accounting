...
describe('Report - Type: Yearly', () => {
  ...
  it(
    'should generate a yearly report in the background',
    async () => {
      ...
      const spyReportGeneratorYearlyGenerate = jest.spyOn(
        ReportYearlyUsecase.prototype,
        'generate',
      );
      ...
      const resultDTO = await controller.generateYearly();
      ...
      const generateResultDTO =
        await spyReportGeneratorYearlyGenerate.mock.results[0].value;
